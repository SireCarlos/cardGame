...
public class game_visual  extends JFrame{
	...
	private JPanel handdisplay = new JPanel();
	private JPanel tabledisplay = new JPanel();
	public Random randomiser;
	public Scanner scan = new Scanner(System.in);
	
	public game_visual(player players[], deck deck){
		...
		this.handdisplay.setLocation(0, 680);
		this.handdisplay.setSize(1920, 400);
		this.handdisplay.setBackground(Color.red);
		this.tabledisplay.setSize(1920, 680);
		this.tabledisplay.setLocation(0, 0);
		this.tabledisplay.setBackground(Color.blue);
		this.add(tabledisplay);
		this.add(handdisplay);
	...
	private void initGame() {
		for(int i = 0; i <= playernumber; i++){
			for(int j = 0; j < 5; j++){
				...
				handdisplay.add(new CardIcon(players[i].getHand().getHandCard(j).getImage()));
			}
		}
	...
	public static void main(String[] args){
		...
		new game_visual(player,  new deck());
		return;
	}
}
